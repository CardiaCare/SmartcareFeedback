...
#define LIST_CAST_TO_EQUAL_FUNC  (int (*)(const void *, const void *))
#define LIST_CAST_TO_EQUAL_BOOL_FUNC  (bool (*)(const void *, const void *))
#define LIST_CAST_TO_FREE_FUNC  (void (*)(void *))
