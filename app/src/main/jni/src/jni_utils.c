...
int init_global_instances(JNIEnv* env, jobject obj) {
    ...
    jclass localMainActivityClass = (*env)->FindClass(env, "com/petrsu/cardiacare/smartcarefeedback/MainActivity");
    ...
    jclass _class_questionnaire = (*env)->FindClass(env, "com/petrsu/cardiacare/smartcarefeedback/Questionnaire");
    ...
    jclass _class_question = (*env)->FindClass(env, "com/petrsu/cardiacare/smartcarefeedback/Question");
    ...
    jclass _class_answer = (*env)->FindClass(env, "com/petrsu/cardiacare/smartcarefeedback/Answer");
    if (_class_answer == NULL) { return -1; }
    class_answer = (jclass * )(*env)->NewGlobalRef(env, _class_answer);
    if (NULL == class_answer) { return -1; }

    jclass _class_answer_item = (*env)->FindClass(env, "com/petrsu/cardiacare/smartcarefeedback/AnswerItem");
    ...
    jclass _class_feedback = (*env)->FindClass(env, "com/petrsu/cardiacare/smartcarefeedback/Feedback");
    ...
    jclass _class_response = (*env)->FindClass(env, "com/petrsu/cardiacare/smartcarefeedback/Response");
    ...
    jclass _class_response_item = (*env)->FindClass(env, "com/petrsu/cardiacare/smartcarefeedback/ResponseItem");
    ...
    add_question = (*env)->GetMethodID(env, class_questionnaire, "addQuestion", "(Lcom/petrsu/cardiacare/smartcarefeedback/Question;)V");
    ...
    add_answer = (*env)->GetMethodID(env, class_question, "setAnswer", "(Lcom/petrsu/cardiacare/smartcarefeedback/Answer;)V");
    if (add_answer == NULL) { return -1; }

    add_subanswer = (*env)->GetMethodID(env, class_answer_item, "addSubAnswer", "(Lcom/petrsu/cardiacare/smartcarefeedback/Answer;)V");
    ...
    add_answer_item_i = (*env)->GetMethodID(env,  class_answer, "addAnswerItem", "(Lcom/petrsu/cardiacare/smartcarefeedback/AnswerItem;)V");
    ...
    add_response = (*env)->GetMethodID(env,  class_feedback, "addResponse", "(Lcom/petrsu/cardiacare/smartcarefeedback/Response;)V");
    if (add_response == NULL) { return -1; }

    add_response_item = (*env)->GetMethodID(env,  class_response, "addResponseItem", "(Lcom/petrsu/cardiacare/smartcarefeedback/ResponseItem;)V");
    if (add_response_item == NULL) { return -1; }

    add_linked_answer_item = (*env)->GetMethodID(env,  class_response_item, "addLinkedAnswerItem", "(Lcom/petrsu/cardiacare/smartcarefeedback/AnswerItem;)V");
